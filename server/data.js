...
// Per-interval cache TTLs — weekly barely moves, 4H moves fastest.
const TTL = {
...
// Twelve Data free tier: 8 credits/min. We sleep 8s between any outbound call.
let lastFetchAt = 0;
...
// Single-symbol fetch — used for /api/pair, /api/chart, and as the per-pair
...
// True if any symbol needs fetching at this interval (drives ETA + progress).
